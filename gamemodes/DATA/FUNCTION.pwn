...
function AssignPlayerData(playerid)
{
	...
	mysql_tquery(g_SQL, sprintf("SELECT * FROM `inventory` WHERE `ID` = '%d'", pData[playerid][pID]), "LoadPlayerItems", "d", playerid);
