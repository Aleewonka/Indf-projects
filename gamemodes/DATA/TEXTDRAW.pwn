//------------[ Textdraw ]------------
//logo
new PlayerText:LogoSimpleAstera[MAX_PLAYERS][1];
...
{
	//asteralogo
	LogoSimpleAstera[playerid][0] = CreatePlayerTextDraw(playerid, 320.000000, 3.000000, "IndolifeROLEPLAY");
	PlayerTextDrawFont(playerid, LogoSimpleAstera[playerid][0], 3);
	PlayerTextDrawLetterSize(playerid, LogoSimpleAstera[playerid][0], 0.258333, 1.250000);
	PlayerTextDrawTextSize(playerid, LogoSimpleAstera[playerid][0], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, LogoSimpleAstera[playerid][0], 1);
	PlayerTextDrawSetShadow(playerid, LogoSimpleAstera[playerid][0], 0);
	PlayerTextDrawAlignment(playerid, LogoSimpleAstera[playerid][0], 2);
	PlayerTextDrawColor(playerid, LogoSimpleAstera[playerid][0], -1);
	PlayerTextDrawBackgroundColor(playerid, LogoSimpleAstera[playerid][0], 255);
	PlayerTextDrawBoxColor(playerid, LogoSimpleAstera[playerid][0], 50);
	PlayerTextDrawUseBox(playerid, LogoSimpleAstera[playerid][0], 0);
	PlayerTextDrawSetProportional(playerid, LogoSimpleAstera[playerid][0], 1);
	PlayerTextDrawSetSelectable(playerid, LogoSimpleAstera[playerid][0], 0);
...
CreateTextDraw()
{
	...
	//Server Name
	ServerName = TextDrawCreate(490.000000, 8.000038, "Indolife ~w~Roleplay");
