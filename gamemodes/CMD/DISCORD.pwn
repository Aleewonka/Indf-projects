...
public DCC_DM_EMBED(str[], pin, id[])
{
	...
	new DCC_Embed:embed = DCC_CreateEmbed(.title="Soul Side Roleplay", .image_url="https://cdn.discordapp.com/attachments/1226527476201558107/1229821802969301062/bandicam_2024-04-16_12-10-25-975.jpg?ex=663113ce&is=661e9ece&hm=c1f5d020af830f885c1db3c24a29d6558375751dc915e3132cdc2cfea4c1d7d6&");
...
public CheckDiscordUCP(DiscordID[], Nama_UCP[])
{
	...
	{
		guild = DCC_FindGuildById("1167807490944143460"); //GANTI INI
		WARGA = DCC_FindRoleById("1222831047516098610"); //GANTI INI
...
{
	new id[21];
    if(channel != DCC_FindChannelById("1222831049256599604")) //GANTI INI
		return 1;
    if(isnull(params)) 
